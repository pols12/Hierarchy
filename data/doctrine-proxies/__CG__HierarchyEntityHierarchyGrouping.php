...
namespace DoctrineProxies\__CG__\Hierarchy\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class HierarchyGrouping extends \Hierarchy\Entity\HierarchyGrouping implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HierarchyGrouping $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setHierarchy(\Hierarchy\Entity\Hierarchy $hierarchy)
    {
