 ...
 */
class ItemHierarchyGrouping extends \ItemHierarchy\Entity\ItemHierarchyGrouping implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ItemHierarchyGrouping $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setHierarchy(\ItemHierarchy\Entity\ItemHierarchy $hierarchy)
    {
