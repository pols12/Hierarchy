...
class Module extends AbstractModule
{
    ...
    public function install(ServiceLocatorInterface $serviceLocator)
    {
        ...
        $connection->exec('CREATE TABLE item_hierarchy_grouping (id INT AUTO_INCREMENT NOT NULL, hierarchy_id INT NOT NULL, `label` VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_888D30B9582A8328 (hierarchy_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB;');
